...
bool warnings() const {
        return (change_time != 7) || (leap_second != 0);
}                                                                               /**< Return true if there is any warning issued. */
...
vector<int> get_src_vector() const {
        return src_vector;
}                                                             /**< Return the binary vector in the for of a vector<int> */
int* get_src_vector_int() const;      /**< Return the binary vector in the for of a int* */


bool OK() const {
        return decoded;
}                                       /**< If the decoding was successful is returned TRUE */
...
bool OE() const {
        return dst;
}                                     /**< Return the flag of summer time */
int ME() const {
        return month;
}                                       /**< Return the month */
int GM() const {
...
int SE() const {
        return change_time;
}                                           /**< Return the warning of change time */
int SI() const {
        return leap_second;
}                                           /**< Return the warning of leapsecond */
...
bool streamOK() const {
        return streamON;
}                                               /**< Return the state of the stream. A 0 is returned for invalid input or output streams. */



int get_timeout() const {
        return timeout;
}                                               /**< Return the decoding timeout in seconds */
...
bool sincronized() const {
        return decoded && (error == 0);
}                                                                 /**< Return TRUE if the SRC has been decoded and sincronized */
...
void yes_sync() {
        do_sync = true;
}                                       /**< Syncronisation ON. In case of play mode, the syncronisation tones are played. In decoding mode, the syncronisation tones are used to syncronize with the minute of the SRC. */
void no_sync() {
        do_sync = false;
}                                       /**< Skip syncronisation */
bool get_sync() const {
        return do_sync;
}                                             /**< Return the syncronisation mode */
...
int internalError() const {
        return error;
}                                               /**< Return the internal error level. */
...
int getMilliseconds() const {
        return msec;
}                                               /**< Return the number of milliseconds after last reference second */
